...
import 'package:escapegame/counter.dart';
import 'package:escapegame/first1.dart';
import 'package:escapegame/firstscreen.dart';

import 'package:escapegame/seondscreen.dart';
...
class _HomeState extends State<Home> {
  ...
  getChatbotReply(
    ...
    //    await rootBundle.loadString('assets/ahmed.json');
...
class TimerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = color;
    double progress = (1.0 - animation.value) * 2 * 3.15;
    canvas.drawArc(Offset.zero & size, 3.15 * 1.5, -progress, false, paint);
  }
